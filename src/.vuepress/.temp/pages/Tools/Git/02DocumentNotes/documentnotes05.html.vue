<template><div><h1 id="_5-git分支开发工作流" tabindex="-1"><a class="header-anchor" href="#_5-git分支开发工作流"><span>5. Git分支开发工作流</span></a></h1>
...
<h2 id="长期分支" tabindex="-1"><a class="header-anchor" href="#长期分支"><span>长期分支</span></a></h2>
...
<h2 id="主题分支-短期分支" tabindex="-1"><a class="header-anchor" href="#主题分支-短期分支"><span>主题分支 (短期分支)</span></a></h2>
...
<figure><img src="https://git-scm.com/book/en/v2/images/topic-branches-1.png" alt="拥有多个主题分支的提交历史。" tabindex="0" loading="lazy"><figcaption>拥有多个主题分支的提交历史。</figcaption></figure>
...
<figure><img src="https://git-scm.com/book/en/v2/images/topic-branches-2.png" alt="合并了  和  分支之后的提交历史。" tabindex="0" loading="lazy"><figcaption>合并了 <code v-pre>dumbidea</code> 和 <code v-pre>iss91v2</code> 分支之后的提交历史。</figcaption></figure>
