<template><div><h1 id="一些关于video方向的论文收集" tabindex="-1"><a class="header-anchor" href="#一些关于video方向的论文收集"><span>一些关于video方向的论文收集</span></a></h1>
...
MILES: Visual BERT Pre-training with Injected Language Semantics for Video-Text Retrieval</p>
<h3 id="_2020-eccv" tabindex="-1"><a class="header-anchor" href="#_2020-eccv"><span>2020 ECCV</span></a></h3>
<p>Efficient Spatio-Temporal Recurrent Neural Network for Video Deblurring<br>
CoTeRe-Net: Discovering Collaborative Ternary Relations in Videos<br>
Visual Relation Grounding in Videos<br>
SODA: Story Oriented Dense Video Captioning Evaluation Framework<br>
Optical Flow Distillation: Towards Efficient and Stable Video Style Transfer<br>
Learning Object Depth from Camera Motion and Video Object Segmentation<br>
Localizing the Common Action Among a Few Videos<br>
Two-Branch Recurrent Network for Isolating Deepfakes in Videos<br>
World-Consistent Video-to-Video Synthesis<br>
AttentionNAS: Spatiotemporal Attention Cell Search for Video Classification<br>
Temporal Coherence or Temporal Motion: Which Is More Critical for Video-Based Person Re-identification?<br>
Learning Event-Driven Video Deblurring and Interpolation<br>
VPN: Learning Video-Pose Embedding for Activities of Daily Living<br>
Joint Learning of Social Groups, Individuals Action and Sub-group Activities in Videos<br>
Naive-Student: Leveraging Semi-Supervised Learning in Video Sequences for Urban Scene Segmentation<br>
RhyRNN: Rhythmic RNN for Recognizing Events in Long and Complex Videos<br>
MuCAN: Multi-correspondence Aggregation Network for Video Super-Resolution<br>
Efficient Semantic Video Segmentation with Per-Frame Inference<br>
TexMesh: Reconstructing Detailed Human Texture and Geometry from RGB-D Video<br>
Deep Space-Time Video Upsampling Networks<br>
Fast Video Object Segmentation Using the Global Context Module<br>
Uncertainty-Aware Weakly Supervised Action Detection from Untrimmed Videos<br>
STEm-Seg: Spatio-Temporal Embeddings for Instance Segmentation in Videos<br>
Procedure Planning in Instructional Videos<br>
Foley Music: Learning to Generate Music from Videos<br>
Online Multi-modal Person Search in Videos<br>
G-LBM: Generative Low-Dimensional Background Model Estimation from Video Sequences<br>
Generating Videos of Zero-Shot Compositions of Actions and Objects<br>
Video Super-Resolution with Recurrent Structure-Detail Network<br>
Shuffle and Attend: Video Domain Adaptation<br>
Flow-edge Guided Video Completion<br>
Towards End-to-End Video-Based Eye-Tracking<br>
Low Light Video Enhancement Using Synthetic Data Produced with an Intermediate Domain Mapping<br>
ScribbleBox: Interactive Annotation Framework for Video Object Segmentation<br>
MINI-Net: Multiple Instance Ranking Network for Video Highlight Detection<br>
AutoTrajectory: Label-Free Trajectory Extraction and Prediction from Videos Using Dynamic Points<br>
Motion Guided 3D Pose Estimation from Videos<br>
SipMask: Spatial Information Preservation for Fast Image and Video Instance Segmentation<br>
BMBC: Bilateral Motion Estimation with Bilateral Cost Volume for Video Interpolation<br>
Video Object Detection via Object-Level Temporal Aggregation<br>
READ: Reciprocal Attention Discriminator for Image-to-Video Re-identification<br>
Multi-level Wavelet-Based Generative Adversarial Network for Perceptual Quality Enhancement of Compressed Video<br>
Unsupervised Video Object Segmentation with Joint Hotspot Tracking<br>
Memory Selection Network for Video Propagation<br>
URVOS: Unified Referring Video Object Segmentation Network with a Large-Scale Benchmark<br>
Clustering Driven Deep Autoencoder for Video Anomaly Detection<br>
Omni-Sourced Webly-Supervised Learning for Video Recognition<br>
Learning Where to Focus for Efficient Video Object Detection<br>
Learning Object Permanence from Video<br>
Temporal Aggregate Representations for Long-Range Video Understanding<br>
Multimodal Memorability: Modeling Effects of Semantics and Decay on Video Memorability<br>
MotionSqueeze: Neural Motion Feature Learning for Video Understanding<br>
Learning Joint Spatial-Temporal Transformations for Video Inpainting<br>
Probabilistic Future Prediction for Video Scene Understanding<br>
Interactive Video Object Segmentation Using Global and Local Transfer Modules<br>
Is Sharing of Egocentric Video Giving Away Your Biometric Signature?<br>
Conditional Entropy Coding for Efficient Video Compression<br>
Self-supervised Video Representation Learning by Pace Prediction<br>
Self-supervised Multi-task Procedure Learning from Instructional Videos<br>
Key Frame Proposal Network for Efficient Pose Estimation in Videos<br>
We Have So Much in Common: Modeling Semantic Relational Set Abstractions in Videos<br>
Self-supervised Learning of Audio-Visual Objects from Video<br>
Knowledge-Based Video Question Answering with Unsupervised Scene Descriptions<br>
RubiksNet: Learnable 3D-Shift for Efficient Video Action Recognition<br>
Self-supervised Keypoint Correspondences for Multi-person Pose Estimation and Tracking in Videos<br>
Motion-Excited Sampler: Video Adversarial Attack with Sparked Prior<br>
DVI: Depth Guided Video Inpainting for Autonomous Driving<br>
Adaptive Video Highlight Detection by Learning from User History<br>
dentity-Aware Multi-sentence Video Description<br>
Mining Inter-Video Proposal Relations for Video Object Detection<br>
TVR: A Large-Scale Dataset for Video-Subtitle Moment Retrieval<br>
Kernelized Memory Network for Video Object Segmentation<br>
Disentangling Multiple Features in Video Sequences Using Gaussian Processes in Variational Autoencoders<br>
Kinematic 3D Object Detection in Monocular Video<br>
...
BIRNAT: Bidirectional Recurrent Neural Networks with Adversarial Training for Video Snapshot Compressive Imaging<br>
...
Proposal-Based Video Completion<br>
Exploiting Temporal Coherence for Self-Supervised One-Shot Video Re-identification<br>
Multi-view Action Recognition Using Cross-View Video Prediction<br>
Learning Discriminative Feature with CRF for Unsupervised Video Object Segmentation<br>
VLANet: Video-Language Alignment Network for Weakly-Supervised Video Moment Retrieval<br>
Video Representation Learning by Recognizing Temporal Transformations<br>
Measuring the Importance of Temporal Features in Video Saliency<br>
Representation Learning on Visual-Symbolic Graphs for Video Understanding<br>
S3Net: Semantic-Aware Self-supervised Depth Estimation with Monocular Videos and Synthetic Data<br>
High-Quality Single-Model Deep Video Compression with Frame-Conv3D and Multi-frame Differential Modulation</p>
